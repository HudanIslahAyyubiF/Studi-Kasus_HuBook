            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="edit-book.php">Add Book</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="edit-category.php">Add Category</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="edit-author.php">Add Author</a>
                        </li>
                        <li class="nav-item">
        ...
        <div class="container">
            <form action="php/edit-book.php" method="post" enctype="multipart/form-data"
                ...
                <div class="mb-3">
                    ...
                    <a href="upload/<?= $book['cover'] ?>" class="link-dark">Current Cover</a>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <a href="upload/<?= $book['file'] ?>" class="link-dark">Current File</a>
                </div>
